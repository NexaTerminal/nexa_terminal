...
- **Sold as a single annual offer per tier** (Nexa 3.0 model):
  - **Basic — €90 / year**
  - **Pro — €190 / year**
- **Prices are NOT stated on the public website.** They surface only inside the terminal buy flow
  (the subscription gate). Public pages sell the value and drive to signup / "request access,"
  not a price tag. Marketing copy should follow this: **lead with value and outcomes, reveal price
  in-app.**
...
- "Правен оддел за вашата фирма — за фиксна годишна цена." (A legal department for your company, for
  a fixed annual fee.)
...
- ROI angle: one avoided lawyer visit ≈ the annual subscription. Make the savings visible.
