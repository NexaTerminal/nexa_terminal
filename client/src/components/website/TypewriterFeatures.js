...
const mkFeatures = [
  "Автоматизација на документи",
  "Б2Б мрежно поврзување",
  "Правни, маркетинг, инвестициски и други вести",
  "Автоматизирана проверка на усогласеност со закони, маркетинг и сајбер безбедност",
  "АИ чатбот трениран на локални закони и пресуди, маркетинг и инвестициски совети",
  "Правни, маркетинг и други обуки за Вашата компанија",
];
