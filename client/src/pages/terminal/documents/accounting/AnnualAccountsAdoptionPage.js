        ...
        <div className={styles['form-section']}>
          ...
          <div className={styles['info-box']} style={{
            ...
            <ul style={{ margin: '8px 0', paddingLeft: '20px' }}>
              ...
              <li>Годишната сметка и финансиските извештаи мора да се усвојат до 30 јуни</li>
              <li>Одлуката ја носи собранието на содружниците на својата седница</li>
              <li>Со усвојување се одобрува работата на управителот за претходната година</li>
              <li>Составен дел се Билансот на успех и Билансот на состојбата</li>
              <li>Одлуката влегува во сила со денот на донесувањето</li>
            </ul>
          </div>
