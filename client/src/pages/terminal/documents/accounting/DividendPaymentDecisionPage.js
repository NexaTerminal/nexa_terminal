        ...
        <div className={styles['form-section']}>
          ...
          <div className={styles['info-box']} style={{
            ...
            <ul style={{ margin: '8px 0', paddingLeft: '20px' }}>
              <li>Документот се базира на член 490 од Законот за трговските друштва</li>
              <li>Дивидендата се исплаќа од акумулирана и/или тековна добивка на друштвото</li>
              <li>Распределбата мора да биде пропорционална на уделите во друштвото</li>
              <li>Бруто износите се оданочуваат со 10% персонален данок на доход</li>
              <li>Исплатата се врши на трансакциска сметка на содружниците</li>
              <li>Одлуката се донесува од собранието на содружниците</li>
            </ul>
          </div>
          ...
          <div className={styles['info-box']} style={{
            ...
            <p style={{ margin: '8px 0' }}>
              Согласно член 490 од Законот за трговските друштва (Службен весник на РМ бр. 28/04),
              содружниците имаат право на исплата на дивиденда од остварената добивка на друштвото.
              Одлуката за исплата на дивиденда се донесува од собранието на содружниците и мора да
              биде во согласност со Актот за основање на друштвото и Книгата на удели.
            </p>
          </div>
