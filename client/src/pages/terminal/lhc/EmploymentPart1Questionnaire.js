...
const EmploymentPart1Questionnaire = () => {
  ...
  const fetchQuestions = async () => {
    try {
      const response = await api.get('/lhc/employment-part1/questions');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await handleCreditOperation(
        async () => api.post('/lhc/employment-part1/evaluate', {
          answers: answers,
          companySize: companySize
        }),
        'правен здравствен преглед - вработување и договори',
        1
      );
      ...
      if (response && response.success) {
        ...
        navigate(`/terminal/legal-screening/employment-part1/report/${response.data._id}`);
      }
    } catch (err) {
          ...
          <main className={styles["dashboard-main"]}>
            <div className={styles["questionnaire-container"]}>
              <div className={styles["questionnaire-header"]}>
                <h1>Работни односи: Дел 1 - Вработување и договори</h1>
      ...
      <div className={styles["dashboard-layout"]}>
        ...
        <main className={styles["dashboard-main"]}>
          <div className={styles["questionnaire-container"]}>
            <div className={styles["questionnaire-header"]}>
              <h1>Работни односи: Дел 1 - Вработување и договори</h1>
              <p>Овој дел опфаќа прашања за процесот на вработување, договори за работа и организација на работата.</p>
            </div>
