...
const EmploymentPart2Questionnaire = () => {
  ...
  const fetchQuestions = async () => {
    try {
      const response = await api.get('/lhc/employment-part2/questions');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await handleCreditOperation(
        async () => api.post('/lhc/employment-part2/evaluate', {
          answers: answers,
          companySize: companySize
        }),
        'правен здравствен преглед - заштита и престанок',
        1
      );
      ...
      if (response && response.success) {
        ...
        navigate(`/terminal/legal-screening/employment-part2/report/${response.data._id}`);
      }
    } catch (err) {
          ...
          <main className={styles["dashboard-main"]}>
            <div className={styles["questionnaire-container"]}>
              <div className={styles["questionnaire-header"]}>
                <h1>Работни односи: Дел 2 - Заштита и престанок</h1>
      ...
      <div className={styles["dashboard-layout"]}>
        ...
        <main className={styles["dashboard-main"]}>
          <div className={styles["questionnaire-container"]}>
            <div className={styles["questionnaire-header"]}>
              <h1>Работни односи: Дел 2 - Заштита и престанок</h1>
              <p>Овој дел опфаќа прашања за заштита на работникот, плаќање и престанок на работниот однос.</p>
            </div>
