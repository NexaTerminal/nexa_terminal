...
const HealthAndSafetyReport = () => {
  ...
  const fetchAssessment = async () => {
    try {
      const response = await api.get(`/lhc/health-safety/assessment/${id}`);
        ...
        <main className={styles["dashboard-main"]}>
          <div className={styles["report-container"]}>
            ...
            <div className={styles["report-header"]}>
              <h1>Извештај за усогласеност - Безбедност и здравје при работа</h1>
            ...
            {assessment.recommendations && assessment.recommendations.length > 0 && (
              <div className={styles["recommendations-section"]}>
                ...
                <p className={styles["recommendations-intro"]}>
                  За да ја подобрите усогласеноста со Законот за безбедност и здравје при работа, препорачуваме да преземете следниве активности:
                </p>
            ...
            <div className={styles["report-actions"]}>
              ...
              <button
                onClick={() => navigate('/terminal/legal-screening/health-safety')}
                className={styles["btn-primary"]}
              >
