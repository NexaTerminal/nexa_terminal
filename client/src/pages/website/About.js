...
const About = () => {
  ...
  const features = useMemo(() => [
    ...
    },
    {
      ...
      highlights: [
        'ГДПР и заштита на лични податоци',
        'Работни односи и вработување',
        'Безбедност и здравје при работа',
        'Потребни деловни акти'
      ]
    },
    {
      id: 'chatbot',
      ...
      highlights: [
        'Одговори базирани на закони',
        'Објаснување на правни термини',
        'Насоки за усогласеност',
        'Достапен секој момент'
      ]
    },
    {
    ...
    },
    {
      id: 'advokat',
      title: 'Најди адвокат',
      tagline: 'Поврзи се со експертите',
      ...
      videoUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
      highlights: [
        'Пребарување по специјализација',
        'Преглед на квалификации и рецензии',
        'Директна комуникација преку платформата',
    ...
    },
    {
      ...
      videoUrl: 'https://www.youtube.com/watch?v=dQw4w9WgXcQ',
      highlights: [
        'Онлајн курсеви за деловно право',
