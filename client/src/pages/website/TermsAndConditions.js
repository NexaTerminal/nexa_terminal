    ...
    <div className={styles.legalPage}>
      ...
      <div className={styles.legalContent}>
        ...
        <section className={styles.legalSection}>
          ...
          <p>
            Nexa Terminal е <strong>образовна платформа</strong> и алатка за автоматизација. Ние <strong>НЕ даваме правен совет</strong> и <strong>НЕ сме адвокатска канцела</strong>. Сите генерирани документи и информации се обезбедени за информативни и образовни цели.
          </p>
        ...
        <section className={styles.legalSection}>
          ...
          <p>
            За пристап до премиум функции, мораte да ја верификувате вашата компанија со обезбедување на:
          </p>
          <ul>
        ...
        <section className={styles.legalSection}>
          ...
          <p>
            Nexa Terminal користи систем со кредити за генерирање на документи. Секој документ чини одреден број кредити. Кредитите можат да се купат преку платформата.
          </p>
          <ul>
            <li>Кредитите се неповратни (осве во случај на техничка грешка)</li>
            <li>Цените може да се менуваат (постоечките кредити не се засегнати)</li>
            <li>Кредитите важат до бришење на сметката</li>
            <li>Неискористени кредити не се рефундираат при затварање на сметка</li>
          </ul>
        </section>
        ...
        <section className={styles.legalSection}>
          ...
          <h3>Лиценца за користење:</h3>
          <ul>
            <li>Добивате ограничена лиценца да ги користите генерираните документи за вашите деловни цели</li>
        ...
        <section className={styles.legalSection}>
          ...
          <p>
            <strong>Форс мажор:</strong> Не одговараме за неиспол нување поради настани надвор од наша контрола (природни непогоди, војни, пандемии, прекини на интернет, итн.).
          </p>
        </section>
        ...
        <section className={styles.legalSection}>
          ...
          <ul>
            ...
            <li>Користите платформата за illegals цели</li>
            <li>Злоупотребувате систем или функции</li>
            <li>Не плаќате за услугите</li>
          </ul>

          <p><strong>При раскинување:</strong> Неискористените кредити се губат и нема рефундирање.</p>
        </section>
