...
const { questions, sanctions, gradeConfig, categoryNames, ANSWER_TYPES, SANCTION_LEVELS } = require('../../data/lhc/employmentPart1Questions');
...
class ComplianceEvaluator {
  ...
  getGradeDescription(grade) {
    const descriptions = {
      'Перфектна усогласеност': `Кај ${this.companyName} постои перфектна усогласеност во делот на вработување и договори.`,
      'Одлична усогласеност': `Кај ${this.companyName} постои одлична усогласеност во делот на вработување и договори.`,
      'Задоволителна усогласеност': `Кај ${this.companyName} постои задоволителна усогласеност во делот на вработување и договори.`,
      'Определена усогласеност': `Кај ${this.companyName} постои определена усогласеност во делот на вработување и договори.`,
      'Делумна усогласеност': `Кај ${this.companyName} постои делумна усогласеност во делот на вработување и договори.`,
      'Ниска усогласеност': `Кај ${this.companyName} постои ниска усогласеност во делот на вработување и договори.`,
      'Исклучително ниска усогласеност': `Кај ${this.companyName} постои исклучително ниска усогласеност во делот на вработување и договори.`
    };
...
async function getAssessmentHistory(req, res) {
  try {
    ...
    const assessments = await db
      ...
      .find({ userId: req.user._id, category: 'employment_part1' })
      .sort({ createdAt: -1 })
      .limit(10)
      .toArray();
