...
const { questions, sanctions, gradeConfig, categoryNames, ANSWER_TYPES, SANCTION_LEVELS } = require('../../data/lhc/employmentPart3Questions');
...
class ComplianceEvaluator {
  ...
  getGradeDescription(grade) {
    const descriptions = {
      'Перфектна усогласеност': `Кај ${this.companyName} постои перфектна усогласеност во делот на работно време и одмор.`,
      'Одлична усогласеност': `Кај ${this.companyName} постои одлична усогласеност во делот на работно време и одмор.`,
      'Задоволителна усогласеност': `Кај ${this.companyName} постои задоволителна усогласеност во делот на работно време и одмор.`,
      'Определена усогласеност': `Кај ${this.companyName} постои определена усогласеност во делот на работно време и одмор.`,
      'Делумна усогласеност': `Кај ${this.companyName} постои делумна усогласеност во делот на работно време и одмор.`,
      'Ниска усогласеност': `Кај ${this.companyName} постои ниска усогласеност во делот на работно време и одмор.`,
      'Исклучително ниска усогласеност': `Кај ${this.companyName} постои исклучително ниска усогласеност во делот на работно време и одмор.`
    };
...
async function getAssessmentHistory(req, res) {
  try {
    ...
    const assessments = await db
      ...
      .find({ userId: req.user._id, category: 'employment_part3' })
      .sort({ createdAt: -1 })
      .limit(10)
      .toArray();
