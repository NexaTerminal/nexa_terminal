...
function generateNDADoc(formData, user, company) {
  ...
  const children = [
    ...
    new Paragraph({
      children: [
        new TextRun({ text: "Договор за доверливост", bold: true, size: 22 }),
      ],
    ...
    new Paragraph({
      children: [
        new TextRun({ text: "на информации", bold: true, size: 22 }),
      ],
      alignment: AlignmentType.CENTER,
      spacing: { after: 200, line: 276 },
    }),
    ...
    new Paragraph({
      children: [
        new TextRun({ text: "Заеднички именувани како \"Договорни/те страни\"", size: 22 }),
      ],
      alignment: AlignmentType.JUSTIFIED,
      spacing: { after: 200, line: 276 },
    }),
    ...
    new Paragraph({
      children: [
        new TextRun({ text: "Дефиниции", bold: true, size: 22 }),
      ],
      alignment: AlignmentType.LEFT,
      spacing: { after: 200, line: 276 },
    }),
    ...
    new Paragraph({
      children: [
        new TextRun({ text: "ДОВЕРЛИВОСТ", bold: true, size: 22 }),
      ],
      alignment: AlignmentType.LEFT,
      spacing: { after: 200, line: 276 },
    }),
    ...
    new Paragraph({
      children: [
        new TextRun({ text: "ПРАВА ОД ИНТЕЛЕКТУАЛНА СОПСТВЕНОСТ", bold: true, size: 22 }),
      ],
      alignment: AlignmentType.LEFT,
      spacing: { after: 200, line: 276 },
    }),
    ...
    new Paragraph({
      children: [
        new TextRun({ text: "ОДГОВОРНОСТ ЗА ШТЕТА", bold: true, size: 22 }),
      ],
      alignment: AlignmentType.LEFT,
      spacing: { after: 200, line: 276 },
    }),
    ...
    new Paragraph({
      children: [
        new TextRun({ text: "ПРЕОДНИ И ЗАВРШНИ ОДРЕДБИ", bold: true, size: 22 }),
      ],
      alignment: AlignmentType.LEFT,
      spacing: { after: 200, line: 276 },
    }),
  ...
  if (additionalTerms && additionalTerms.trim() !== '') {
    children.push(
      new Paragraph({
        children: [
          new TextRun({ text: "ДОПОЛНИТЕЛНИ УСЛОВИ", bold: true, size: 22 }),
        ],
        alignment: AlignmentType.LEFT,
        spacing: { after: 200, line: 276 },
      }),
        ...
        new TableRow({
          children: [
            ...
            new TableCell({
              ...
              children: [
                new Paragraph({
                  children: [new TextRun({ text: "ПРВА ДОГОВОРНА СТРАНА:", size: 22 })],
                  alignment: AlignmentType.LEFT,
                  spacing: { after: 200, line: 276 }
                }),
                new Paragraph({
                ...
                new Paragraph({
                  children: [new TextRun({ text: `Управител ${companyManager}`, size: 22 })],
                  alignment: AlignmentType.LEFT,
            ...
            new TableCell({
              ...
              children: [
                new Paragraph({
                  children: [new TextRun({ text: "ВТОРА ДОГОВОРНА СТРАНА:", size: 22 })],
                ...
                new Paragraph({
                  children: [new TextRun({ text: secondPartyName, size: 22 })],
                  alignment: AlignmentType.RIGHT,
                  spacing: { after: 300, line: 276 }
                }),
              ],
